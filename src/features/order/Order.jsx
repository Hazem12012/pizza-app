...
function Order() {
  const pizzaPriceStyle = 'text-sm font-medium text-stone-600 ';
  ...
  return (
    <div className="space-y-8 px-4 py-6">
      ...
      <ul className="border-stone-300 divide-stone-300 divide-y border-t border-b">
        {cart.map((item) => {
