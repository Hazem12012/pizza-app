...
function Button({ children, disabled, to, type, onClick, style }) {
  const pase =
    ...
    `  text-sm cursor-pointer rounded-full bg-yellow-400
      font-semibold tracking-wide text-stone-800 
      uppercase transition-colors duration-300 hover:bg-yellow-300 
      hover:text-stone-500 focus:ring focus:ring-yellow-300
       focus:ring-offset-2 focus:outline-none focus:bg-yellow-300 ` + style ;
  const styles = {
